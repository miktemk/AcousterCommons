...
public class ContextKeyEvent
{
	private int keyCode, eventType;
	private boolean isProcessed;

	public ContextKeyEvent() {
		super();
		isProcessed = false;
	}
	public ContextKeyEvent(int keyCode, int eventType) {
		super();
		set(keyCode, eventType);
	}
	public ContextKeyEvent set(int keyCode, int eventType) {
	...
	/** returns ContextKeyEvent.SOME_KEY constant
	 * (I copied these values from java.awt.event.KeyEvent
	 * TODO:  Are Android the same?) */
	...
	// android kb codes... apparently they are different
	public static final int ANDROID_NUMPAD1 = 145;
	public static final int ANDROID_NUMPAD2 = 146;
	public static final int ANDROID_NUMPAD3 = 147;
	public static final int ANDROID_NUMPAD4 = 148;
	public static final int ANDROID_NUMPAD5 = 149;
	public static final int ANDROID_NUMPAD6 = 150;
	public static final int ANDROID_NUMPAD7 = 151;
	public static final int ANDROID_NUMPAD8 = 152;
	public static final int ANDROID_NUMPAD9 = 153;
	public static final int ANDROID_NUMPAD0 = 154;
	public static final int ANDROID_MULTIPLY = 155;
}
